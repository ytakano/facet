---
applyTo: "ocaml/parser.mly,ocaml/lexer.ml,ocaml/ast.ml,ocaml/debruijn.ml,ocaml/fir.ml"
---

Use when changing surface syntax, parser, desugaring, elaboration to core AST, or source-to-core translation.
