...
- Rocq has env-aware associated compatibility helpers and checked wrapper
  ...
  facts, exact-body route scoped-package wrappers, seen/callee-seen bridge facts, direct-callee component/summary facts, alpha direct-callee facts, and
  component-body callback/ready providers, plus the summary call-package
