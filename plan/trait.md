...
- Proof infrastructure for direct-call receivers is concentrated around the
  ...
  active/strict public no-receiver component-body-summary provider wrappers, strict branch provider/check wrappers, canonical runtime prefix wrapper, branch/public package/package-at-all exact-body summary-evidence wrappers, active and receiver-method public no-receiver exact-body wrappers, mixed component-summary/check store-static cleanup, and provider/check routes,
