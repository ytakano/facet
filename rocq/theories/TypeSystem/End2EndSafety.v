  ...
  forall env env' f_component,
    ...
    forall fname args synthetic_body,
      ...
      fn_root_shadow_synthetic_direct_call_ready_summary_evidence_at
        (global_env_with_local_bounds env' (fn_bounds f_component)) fname.
Proof.
  intros env env' f_component Hprog Hin Hcomponent_check Hexact.
  destruct (infer_program_env_end2end_strict_exact_closure_component_body_direct_callee_callbacks_in_local_bounds_family
              env env' f_component Hprog Hin Hcomponent_check Hexact)
    as [Hsummary_at _].
  exact Hsummary_at.
Qed.

Lemma infer_program_env_end2end_strict_exact_closure_component_body_target_callback_in_local_bounds_family :
  forall env env' f_component,
    infer_program_env_end2end_strict_exact_closure env = infer_ok env' ->
    In f_component (env_fns env') ->
    check_fn_root_shadow_no_capture_direct_call_component_store_safe_summary
...
Lemma infer_program_env_end2end_strict_exact_closure_component_body_alpha_nested_summary_at_callback_in_local_bounds_family :
  forall env env' f_component,
    infer_program_env_end2end_strict_exact_closure env = infer_ok env' ->
    In f_component (env_fns env') ->
    check_fn_root_shadow_no_capture_direct_call_component_store_safe_summary
...
Proof.
  ...
  - exact Hbase.
  - intros env0 fname fdef fcall used used' fname_body args_body
      synthetic_body Hfamily Hin _Hname _Hrename _Htarget.
    eapply infer_program_env_end2end_strict_exact_closure_route_summary_and_exact_target_in_local_bounds_family.
    + exact Hprog.
    + exact Hbase.
    + exact Hfamily.
...
Proof.
  intros Hscope_synthetic Htyping_prefix Hprefix_ready Hroots_ready
    ...
    Hinitial Hin Hstore Heval.
  eapply infer_program_env_end2end_strict_exact_closure_big_step_safe_checked_initial_ready_with_alpha_evidence_at_call_route_with_component_local_bounds_family_callbacks.
  - exact Hscope_synthetic.
  ...
  - exact Hprog.
  - intros f_component Hin_component Hcomponent_check.
    eapply infer_program_env_end2end_strict_exact_closure_component_local_bounds_route_of_component_check_provider.
    + exact Hscope_synthetic.
    + exact Htyping_prefix.
    + exact Hprefix_ready.
    + exact Hroots_ready.
