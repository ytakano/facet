...
8. **M7: Soundness proofs 拡張** [done] / legacy 残あり
   ...
   - `EnvTypingRules.v` に struct-aware env checker の Prop surface と、struct literal、field place、field replace/assign、path borrow の構造的規則を追加済み。
