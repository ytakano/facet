...
- Verification note: `rocq compile -R theories Facet
  ...
  wrappers over the summary-call packages, summary-at exact-package and
  summary-at call-route wrappers, alpha-route component-summary/closure-target
  and branch-local strict-check wrappers, and exact-body route-package wrappers,
