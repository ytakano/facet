  ...
  - simpl in Hvariant.
    ...
    + eapply IHtail in Hvariant; [| exact Hbranch].
      ...
      destruct Hrest as [HRpayload' [Hnodup' [Hctx_none' [Hroot_none' [Hbinders'
        [Hparams' [Htyped' [Hno_lbound' [Hparams_ok' [Hroots_excl' [Hremove'
      ...
      | Hready_new : provenance_ready_expr e_new,
        ...
        Hcompat : ty_compatible_b Ω ?T_new ?T_old = true |- _ =>
          ...
          destruct (sctx_same_bindings_lookup Σ Σ1 x_target T_root st
            ...
            as [st1 HΣ1];
          destruct (store_typed_lookup_sctx
          ...
          by (eapply store_typed_update_path_typed;
              [ exact Hstore1
              | exact Hpres_update
              | exact Htarget_update
              | exact Hvnew_update
          ...
          by (unfold store_restore_path in Hrestore;
              eapply store_update_state_ref_targets_preserved; exact Hrestore);
          assert (Hstore_final : store_typed env s3 Σ1)
          by (unfold store_restore_path in Hrestore;
              eapply store_typed_update_state_same_ctx;
              [ exact Hstore2
      ...
      | Hready_new : provenance_ready_expr e_new,
        ...
        Hcompat : ty_compatible_b Ω ?T_new ?T_old = true |- _ =>
          ...
          by (eapply store_update_path_ref_targets_preserved;
              ...
              | exact Hvnew_update
              | exact Hupdate ]);
          assert (Hstore_final : store_typed env s2 Σ')
          by (eapply store_typed_update_path_typed;
              [ exact Hstore1
              | exact Hpres_update
              | exact Htarget_update
  ...
  - intros s s_scrut s_branch s' scrut branches enum_name variant_name
    ...
    + assert (Hvdef_runtime_tail : vdef_runtime = vdef_typed_runtime).
      ...
      destruct Htail_branch as [HRpayload [Hnodup_branch_params
        ...
        [Htyped_branch [Hno_lbound_branch [Hparams_ok_branch [Hroots_excl_branch [Hremove_branch
