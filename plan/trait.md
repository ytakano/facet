...
- Helper-level associated compatibility soundness is available for
  ...
  typed and prefix-store-typed roots-ready bridges can consume the sctx view
  directly. Assoc root value and argument typing bridge to the same roots-ready
  invariants. Ordinary
