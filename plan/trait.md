...
- Proof infrastructure for direct-call receivers is concentrated around the
  ...
  component-body summary provider leaves,
  local-bounds, scoped-package, non-captured, component-provider,
  branch-evidence, store-safe/summary evidence leaves, prefix/summary runtime leaves, public-callback
  provider/check and strict-active leaves, component-only derived leaves, and component-check provider wrappers, plus component-only boolean bridges.
