...
- Rocq has env-aware associated compatibility helpers and checked wrapper
  ...
  facts, exact-body route scoped-package wrappers, seen/callee-seen bridge facts, direct-callee component/summary facts, alpha direct-callee facts, component-body callback/ready providers, and
  component-body route-package providers, plus the summary call-package
