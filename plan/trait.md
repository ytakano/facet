...
- A mixed assoc direct-receiver endpoint,
  ...
  naming compatibility now consumed by most core route cleanup bridge branches.
...
- A trial CLI switch to
  ...
  compatibility helper, and most core route cleanup bridge branches consume it.
  The public bridge still needs the remaining route-package callback chain to
