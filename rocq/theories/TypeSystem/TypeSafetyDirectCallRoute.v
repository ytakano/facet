...
Proof.
  ...
  { intro n_call.
    ...
    - intros env s fname args s' v Heval Hheight Omega n R Σ T Σ' R' roots
        ...
        Hevidence.
      eapply eval_preserves_typing_roots_synthetic_direct_call_ready_summary_at_prefix_call_height_statement_evidence_at_current_from_less_callbacks_and_exact_body_call_route_package;
        try eassumption.
    ...
    - intros env s fname args s' v Heval Hheight Omega n R Σ T Σ' R' roots
        ...
        Hcover Hroots Hshadow Hrn Hframe Hfresh Hparam.
      eapply eval_preserves_frame_param_scope_synthetic_direct_call_ready_summary_at_prefix_call_height_statement_evidence_at_current_from_less_callbacks_and_exact_body_call_route_package;
        try eassumption.
      + intros m Hlt. exact (proj1 (IH m Hlt)).
      + intros m Hlt. exact (proj2 (IH m Hlt)). }
  split.
