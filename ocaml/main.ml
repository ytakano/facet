  ...
  let print_trait_gate_diagnostics checked_env =
    ...
    print_gate "trait-direct-receiver-split-ready"
      (check_env_root_shadow_no_receiver_component_ready_body_or_local_narrow_summary_provider_check_with_direct_receiver_splits
         checked_env);
    print_gate "trait-direct-receiver-split-end2end-ready"
      (check_env_end2end_direct_receiver_split_ready checked_env);
    List.iter
      (fun f ->
    ...
    print_gate "trait-no-receiver-local-bounds-narrow-summary"
      (check_env_root_shadow_no_receiver_component_local_bounds_narrow_summary_provider_check
         checked_env);
    print_gate "trait-no-receiver-ready-body-or-local-narrow-summary"
