...
Theorem eval_preserves_typing_direct_call_roots_synthetic_ready_with_old_evidence :
  forall env s e s' v,
    eval env s e s' v ->
    forall (Ω : outlives_ctx) (n : nat) R Σ T Σ' R' roots,
      preservation_direct_call_ready_expr e ->
...
Proof.
  eapply
    (eval_preserves_typing_direct_call_roots_synthetic_ready_with_old_evidence_with_preservation_core
      eval_preserves_typing_roots_ready_mutual
      eval_preserves_typing_ready_mutual
      eval_preserves_roots_ready_mutual
      eval_preserves_frame_scope_roots_ready_mutual
