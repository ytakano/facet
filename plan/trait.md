...
- Short UFCS accepts receiver types known before checker execution: function
  ...
  evaluation and inversion helpers, structured receiver-method checker view lemmas, direct and generic typed
...
1. Finish UFCS receiver hardening.
   ...
   - Direct-call receivers are not an OCaml-only switch: existing store-safe
     ...
     constructors, hidden receiver `EVar` evaluation and inversion helpers, hidden-let
