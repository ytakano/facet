...
description: Use when changing Facet typing rules, ownership rules, effects, borrowing, lifetimes, drop elaboration, executable checker definitions, or type-safety-related Rocq proofs.
---
