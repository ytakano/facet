...
Proof.
  ...
  intros env0 Hfamily s0 fname args s1 v1 n_call Heval_call
    ...
    _Hevidence_at.
  pose proof (Hprovider f_component Hin_component Hcomponent_check)
    as [_ Hsummary_base].
  destruct Hfamily as [bounds ->].
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    ...
    Hprog Hcomponent_body_provider_when_no_receiver Hinitial Hin Hstore Heval.
  ...
  - exact Hprog.
  - intros f_component Hin_component Hcomponent_check.
    eapply component_body_summary_check_provider_local_bounds_route.
    + exact Hsynthetic_route.
    + exact Hroot_names.
    + exact Hroot_keys.
    + eapply infer_program_env_end2end_assoc_direct_receiver_mixed_component_body_summary_check_provider_in_env.
      * exact Hprog.
      * exact Hcomponent_body_provider_when_no_receiver.
    + exact Hin_component.
    + exact Hcomponent_check.
  - exact Hinitial.
  - exact Hin.
...
Proof.
  ...
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_prefix.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  - exact Hroots_ready.
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_route_prefix :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready Hstatic env env' f s s' v
    Hprog Hbody_summary_provider_when_no_receiver Hinitial Hin Hstore Heval.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_prefix.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  ...
  - intros Hno_receiver.
    eapply component_body_summary_check_provider_in_env_of_body_summary_provider.
    exact (Hbody_summary_provider_when_no_receiver Hno_receiver).
  - exact Hinitial.
  - exact Hin.
  - exact Hstore.
  - exact Heval.
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_store_safe_provider_prefix :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready Hstatic env env' f s s' v
    Hprog Hstore_safe_provider_when_no_receiver Hinitial Hin Hstore Heval.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_prefix.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  ...
  - exact Hprog.
  - intros Hno_receiver.
    eapply component_body_summary_check_provider_in_env_of_store_safe_provider.
    exact (Hstore_safe_provider_when_no_receiver Hno_receiver).
  - exact Hinitial.
  - exact Hin.
  - exact Hstore.
  - exact Heval.
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_route :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_summary_provider_route_prefix.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  - exact Hroots_ready.
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_store_safe_provider :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_public_callbacks_big_step_safe_checked_initial_ready_with_no_receiver_component_body_store_safe_provider_prefix.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  - exact Hroots_ready.
