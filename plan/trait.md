...
- Rocq has env-aware associated compatibility helpers and checked wrapper
  ...
  wrappers, component-body route-package providers, route-package wrappers
  through prefix-scope consumers, and assoc-aware summary-call-package wrappers. The old ordinary
