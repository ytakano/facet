...
Definition check_env_root_shadow_direct_receiver_method_or_no_capture_direct_component_store_safe_summary
    (env : global_env) : bool :=
  forallb
...
Definition check_fn_root_shadow_captured_call_store_safe_summary_absent
    (env : global_env) (fdef : fn_def) : bool :=
  negb (check_fn_root_shadow_captured_call_store_safe_summary env fdef).

Definition check_env_root_shadow_captured_call_store_safe_summary_absent
    (env : global_env) : bool :=
...
Definition check_fn_root_shadow_captured_call_store_safe_summary_with_receiver_methods
    (env : global_env) (fdef : fn_def) : bool :=
  check_fn_root_shadow_captured_call_store_safe_summary_with_direct_receiver_method
    env fdef ||
...
Definition check_env_root_shadow_captured_call_store_safe_summary_with_receiver_methods
    (env : global_env) : bool :=
  forallb
...
Definition check_fn_root_shadow_captured_call_store_safe_with_direct_receiver_method_or_no_capture_direct_component_summary
    (env : global_env) (fdef : fn_def) : bool :=
  check_fn_root_shadow_captured_call_store_safe_summary_with_direct_receiver_method
    env fdef ||
  check_fn_root_shadow_no_capture_direct_call_component_store_safe_summary
...
Definition check_env_root_shadow_captured_call_store_safe_with_direct_receiver_method_or_no_capture_direct_component_summary
    (env : global_env) : bool :=
  forallb
...
Definition check_fn_root_shadow_assoc_direct_receiver_base_summary
    (env : global_env) (f : fn_def) : bool :=
  check_fn_root_shadow_captured_call_store_safe_or_no_capture_direct_component_exact_closure_summary
    env f ||
  check_fn_root_shadow_captured_call_store_safe_summary_with_direct_receiver_method
    env f.

Definition infer_fn_env_end2end_assoc_direct_receiver_base
...
Fixpoint infer_fns_env_end2end_assoc_direct_receiver_base
    (env : global_env) (fns : list fn_def) : infer_result unit :=
  match fns with
  | [] => infer_ok tt
  | f :: rest =>
      ...
      | infer_err err => infer_err (ErrInFunction (fn_name f) err)
      | infer_ok _ =>
          infer_fns_env_end2end_assoc_direct_receiver_base env rest
      end
  end.

Definition infer_program_env_end2end_assoc_direct_receiver_base
  ...
  if global_names_unique_b env_alpha then
    ...
    | infer_err err => infer_err err
    | infer_ok env_elab =>
        match infer_fns_env_end2end_assoc_direct_receiver_base
...
Definition check_program_env_end2end_assoc_direct_receiver_base
    (env : global_env) : bool :=
...
Definition check_env_end2end_direct_receiver_ready (env : global_env) : bool :=
...
Definition infer_program_env_end2end_assoc_direct_receiver_mixed
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition infer_program_env_end2end_assoc_direct_receiver_base_mixed
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc_direct_receiver_base env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition check_program_env_end2end_assoc_direct_receiver_base_mixed
    (env : global_env) : bool :=
...
Definition infer_program_env_end2end_assoc_direct_receiver_base_combined
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc_direct_receiver_base env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition check_program_env_end2end_assoc_direct_receiver_base_combined
    (env : global_env) : bool :=
...
Definition infer_program_env_end2end_assoc_direct_receiver_base_combined_provenance_ready_checks
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc_direct_receiver_base_combined env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition check_program_env_end2end_assoc_direct_receiver_base_combined_provenance_ready_checks
    (env : global_env) : bool :=
...
Definition infer_program_env_end2end_assoc_direct_receiver_base_combined_preservation_ready_checks
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc_direct_receiver_base_combined env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition check_program_env_end2end_assoc_direct_receiver_base_combined_preservation_ready_checks
    (env : global_env) : bool :=
...
Definition check_program_env_end2end_assoc_direct_receiver_base_combined_component_only_summary_ready_checks
    (env : global_env) : bool :=
...
Definition infer_program_env_end2end_assoc_direct_receiver_base_direct_component_ready_checks
    (env : global_env) : infer_result global_env :=
  match infer_program_env_end2end_assoc_direct_receiver_base_direct_component env with
  | infer_err err => infer_err err
  | infer_ok env' =>
...
Definition check_program_env_end2end_assoc_direct_receiver_base_direct_component_ready_checks
    (env : global_env) : bool :=
