...
- Verification note: `rocq compile -R theories Facet
  ...
  the assoc-base mixed summary-package, summary-at package, alpha-route component-summary/closure-target and branch-local strict-check wrappers, and exact-body route-package wrappers, including the checked
