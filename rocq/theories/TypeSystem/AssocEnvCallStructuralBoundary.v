...
Lemma typed_fn_env_roots_assoc_boundary_store_keys_named :
...
Lemma typed_fn_env_roots_assoc_boundary_store_keys_named_prefix :
  forall env f R0 R_out roots s,
    typed_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Lemma typed_fn_env_roots_assoc_boundary_store_roots_named :
  forall env f R0 R_out roots s,
    typed_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_roots_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Lemma typed_fn_env_roots_assoc_boundary_store_roots_named_prefix :
  forall env f R0 R_out roots s,
    typed_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_roots_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Lemma typed_fn_env_roots_assoc_boundary_store_named :
  forall env f R0 R_out roots s,
    typed_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  ...
  split.
  - intros Hstore.
    eapply typed_env_roots_assoc_boundary_store_named; eassumption.
  - split; assumption.
Qed.

Lemma typed_fn_env_roots_assoc_boundary_store_named_prefix :
  forall env f R0 R_out roots s,
    typed_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  ...
  split.
  - intros Hstore.
    eapply typed_env_roots_assoc_boundary_store_named_prefix; eassumption.
  - split; assumption.
Qed.

Lemma checked_fn_env_roots_assoc_boundary_store_keys_named :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  ...
  eapply typed_fn_env_roots_assoc_boundary_store_keys_named.
  - eapply checked_fn_env_roots_assoc_boundary_typed. exact Hchecked.
  - exact Hshadow.
  - exact Hkeys.
Qed.

Lemma checked_fn_env_roots_assoc_boundary_store_keys_named_prefix :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  intros env f R0 R_out roots s Hchecked Hshadow Hkeys.
  eapply typed_fn_env_roots_assoc_boundary_store_keys_named_prefix.
  - eapply checked_fn_env_roots_assoc_boundary_typed. exact Hchecked.
  - exact Hshadow.
  - exact Hkeys.
Qed.

Lemma checked_fn_env_roots_assoc_boundary_store_roots_named :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_roots_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  ...
  eapply typed_fn_env_roots_assoc_boundary_store_roots_named.
  - eapply checked_fn_env_roots_assoc_boundary_typed. exact Hchecked.
  - exact Hshadow.
  - exact Hnamed.
Qed.

Lemma checked_fn_env_roots_assoc_boundary_store_roots_named_prefix :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_roots_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Proof.
  intros env f R0 R_out roots s Hchecked Hshadow Hnamed.
  eapply typed_fn_env_roots_assoc_boundary_store_roots_named_prefix.
  - eapply checked_fn_env_roots_assoc_boundary_typed. exact Hchecked.
  - exact Hshadow.
  - exact Hnamed.
Qed.

Lemma checked_fn_env_roots_assoc_boundary_store_named :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Lemma checked_fn_env_roots_assoc_boundary_store_named_prefix :
  forall env f R0 R_out roots s,
    checked_fn_env_roots_assoc_boundary env f R0 R_out roots ->
    root_env_no_shadow R0 ->
    root_env_sctx_keys_named R0 (sctx_of_ctx (fn_body_ctx f)) ->
...
Theorem infer_full_env_roots_checked_assoc_boundary_store_named :
  forall env f R0 T Gamma_out R_out roots s,
    infer_full_env_roots_checked env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Proof.
  ...
  eapply checked_fn_env_roots_checked_assoc_boundary_store_named.
  - eapply infer_full_env_roots_checked_assoc_boundary_sound. exact Hinfer.
  - exact Hshadow.
  - exact Hkeys.
  - exact Hroots.
...
Theorem infer_full_env_roots_checked_assoc_boundary_store_named_prefix :
  forall env f R0 T Gamma_out R_out roots s,
    infer_full_env_roots_checked env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Proof.
  intros env f R0 T Gamma_out R_out roots s Hinfer Hshadow Hkeys Hroots.
  eapply checked_fn_env_roots_checked_assoc_boundary_store_named_prefix.
  - eapply infer_full_env_roots_checked_assoc_boundary_sound. exact Hinfer.
  - exact Hshadow.
  - exact Hkeys.
  - exact Hroots.
...
Theorem infer_fn_env_end2end_assoc_boundary_store_named :
  forall env f T Gamma_out R_out roots s,
    infer_fn_env_end2end env f = infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow
      (initial_root_env_for_params (fn_params f ++ fn_captures f)) ->
...
Theorem infer_fn_env_end2end_assoc_boundary_store_named_prefix :
  forall env f T Gamma_out R_out roots s,
    infer_fn_env_end2end env f = infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow
      (initial_root_env_for_params (fn_params f ++ fn_captures f)) ->
...
Lemma infer_fns_env_end2end_in_assoc_boundary_store_named :
  forall env fns f s,
    infer_fns_env_end2end env fns = infer_ok tt ->
    In f fns ->
    root_env_no_shadow
...
Proof.
  ...
  destruct (infer_fns_env_end2end_in_assoc_boundary_sound env fns f Hfns Hin)
    as [T [Gamma_out [R_out [roots [Hend _]]]]].
  destruct (infer_fn_env_end2end_assoc_boundary_store_named
      env f T Gamma_out R_out roots s Hend Hshadow)
    as [T_body [Gamma_body [Hnamed [Hcompat Hparams]]]].
  exists T, Gamma_out, R_out, roots, T_body, Gamma_body.
  split; [exact Hend |].
  split; [exact Hnamed |].
  split; assumption.
...
Lemma infer_fns_env_end2end_in_assoc_boundary_store_named_prefix :
  forall env fns f s,
    infer_fns_env_end2end env fns = infer_ok tt ->
    In f fns ->
    root_env_no_shadow
...
Proof.
  ...
  destruct (infer_fns_env_end2end_in_assoc_boundary_sound env fns f Hfns Hin)
    as [T [Gamma_out [R_out [roots [Hend _]]]]].
  destruct (infer_fn_env_end2end_assoc_boundary_store_named_prefix
      env f T Gamma_out R_out roots s Hend Hshadow)
    as [T_body [Gamma_body [Hnamed [Hcompat Hparams]]]].
  exists T, Gamma_out, R_out, roots, T_body, Gamma_body.
  split; [exact Hend |].
...
Theorem infer_program_env_end2end_assoc_boundary_store_named :
  forall env env' f s,
    infer_program_env_end2end env = infer_ok env' ->
    In f (env_fns env') ->
    root_env_no_shadow
...
Proof.
  ...
  destruct (infer_fns_env_end2end env_elab (env_fns env_elab))
    as [[] | err] eqn:Hfns; try discriminate.
  inversion Hprog; subst env'.
  eapply infer_fns_env_end2end_in_assoc_boundary_store_named; eauto.
Qed.

Theorem infer_program_env_end2end_assoc_boundary_store_named_prefix :
  forall env env' f s,
    infer_program_env_end2end env = infer_ok env' ->
    In f (env_fns env') ->
    root_env_no_shadow
...
Proof.
  ...
  destruct (infer_fns_env_end2end env_elab (env_fns env_elab))
    as [[] | err] eqn:Hfns; try discriminate.
  inversion Hprog; subst env'.
  eapply infer_fns_env_end2end_in_assoc_boundary_store_named_prefix; eauto.
Qed.

Theorem check_program_env_end2end_assoc_boundary_store_named :
  forall env env' f s,
    check_program_env_end2end env = true ->
    infer_program_env_end2end env = infer_ok env' ->
    In f (env_fns env') ->
...
Proof.
  intros env env' f s _ Hprog Hin Hshadow.
  eapply infer_program_env_end2end_assoc_boundary_store_named; eauto.
Qed.

Theorem check_program_env_end2end_assoc_boundary_store_named_prefix :
  forall env env' f s,
    check_program_env_end2end env = true ->
    infer_program_env_end2end env = infer_ok env' ->
    In f (env_fns env') ->
...
Proof.
  intros env env' f s _ Hprog Hin Hshadow.
  eapply infer_program_env_end2end_assoc_boundary_store_named_prefix; eauto.
Qed.
...
Theorem infer_env_roots_shadow_safe_assoc_boundary_sound :
  forall env f R0 T Gamma_out R_out roots,
...
Proof.
  unfold typed_fn_env_roots_assoc_boundary.
  intros env f R0 T Gamma_out R_out roots Hinfer.
  destruct (infer_env_roots_shadow_safe_sound env f R0 T Gamma_out
    R_out roots Hinfer) as [T_body [Gamma_body [Hbody [Hcompat Hparams]]]].
  exists T_body, Gamma_body.
  repeat split; try assumption.
  apply TERAssocBoundary_Roots.
  eapply typed_env_roots_shadow_safe_roots. exact Hbody.
Qed.

Theorem infer_env_roots_shadow_safe_assoc_boundary_store_named :
  forall env f R0 T Gamma_out R_out roots s,
    infer_env_roots_shadow_safe env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Proof.
  intros env f R0 T Gamma_out R_out roots s Hinfer Hshadow Hkeys Hroots.
  eapply typed_fn_env_roots_assoc_boundary_store_named.
  - eapply infer_env_roots_shadow_safe_assoc_boundary_sound. exact Hinfer.
  - exact Hshadow.
  - exact Hkeys.
  - exact Hroots.
Qed.

Theorem infer_env_roots_shadow_safe_assoc_boundary_store_named_prefix :
  forall env f R0 T Gamma_out R_out roots s,
    infer_env_roots_shadow_safe env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Theorem infer_env_roots_shadow_safe_checked_assoc_boundary_sound :
  forall env f R0 T Gamma_out R_out roots,
...
Proof.
  unfold typed_fn_env_roots_checked_assoc_boundary.
  intros env f R0 T Gamma_out R_out roots Hinfer.
  destruct (infer_env_roots_shadow_safe_checked_sound env f R0 T Gamma_out
    R_out roots Hinfer) as [T_body [Gamma_body [Hbody [Hcompat Hparams]]]].
  exists T_body, Gamma_body.
  repeat split; try assumption.
  apply TERCAssocBoundary_Checked.
  eapply typed_env_roots_shadow_safe_checked_checked. exact Hbody.
Qed.

Theorem infer_env_roots_shadow_safe_checked_assoc_boundary_store_named :
  forall env f R0 T Gamma_out R_out roots s,
    infer_env_roots_shadow_safe_checked env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Proof.
  intros env f R0 T Gamma_out R_out roots s Hinfer Hshadow Hkeys Hroots.
  eapply typed_fn_env_roots_checked_assoc_boundary_store_named.
  - eapply infer_env_roots_shadow_safe_checked_assoc_boundary_sound.
    exact Hinfer.
  - exact Hshadow.
  - exact Hkeys.
  - exact Hroots.
...
Theorem infer_env_roots_shadow_safe_checked_assoc_boundary_store_named_prefix :
  forall env f R0 T Gamma_out R_out roots s,
    infer_env_roots_shadow_safe_checked env f R0 =
      infer_ok (T, Gamma_out, R_out, roots) ->
    root_env_no_shadow R0 ->
...
Lemma infer_roots_type_forall_elab_checked_assoc_boundary :
  forall fuel env Omega n callee u type_params bounds body R R1 Sigma Sigma1
      args arg_tys type_args_ret Sigma' R' arg_roots roots_callee,
    typed_env_roots env Omega n R Sigma callee
      (MkTy u (TTypeForall type_params bounds body)) Sigma1 R1
...
Proof.
  intros fuel env Omega n callee u type_params bounds body R R1 Sigma Sigma1
    ...
    Hcollect Hexpr Hcall.
  eapply typed_env_roots_checked_assoc_boundary_of_assoc_call_boundary.
  eapply infer_roots_type_forall_elab_assoc_structural_boundary; eassumption.
Qed.
...
Lemma infer_roots_mixed_forall_elab_checked_assoc_boundary :
  forall fuel env Omega n callee u u_body m bounds type_params type_bounds body
      R R1 Sigma Sigma1 args arg_tys type_args_ret Sigma' R' arg_roots
      roots_callee,
    typed_env_roots env Omega n R Sigma callee
...
Proof.
  intros fuel env Omega n callee u u_body m bounds type_params type_bounds body
    ...
    roots_callee Hcallee Hcollect Hexpr Hcall.
  eapply typed_env_roots_checked_assoc_boundary_of_assoc_call_boundary.
  eapply infer_roots_mixed_forall_elab_assoc_structural_boundary; eassumption.
Qed.
...
Theorem infer_fn_env_end2end_assoc_entry_boundary_sound :
  forall env f T Gamma_out R_out roots,
    infer_fn_env_end2end_assoc env f = infer_ok (T, Gamma_out, R_out, roots) ->
    checked_fn_env_roots_checked_assoc_boundary env f
      (initial_root_env_for_params (fn_params f ++ fn_captures f))
      R_out roots.
Proof.
...
Lemma infer_fns_env_end2end_assoc_in_boundary_sound :
  forall env fns f,
...
Proof.
  ...
  - contradiction.
  - simpl in Hinfer, Hin.
    destruct (infer_fn_env_end2end_assoc env f0)
      as [[[[T0 Gamma0] R0_out] roots0] | err] eqn:Hhead; try discriminate.
    destruct Hin as [Heq | Hin].
    + subst f0.
      exists T0, Gamma0, R0_out, roots0. split.
      * exact Hhead.
      * eapply infer_fn_env_end2end_assoc_entry_boundary_sound. exact Hhead.
    + eapply IH; eauto.
Qed.

Theorem infer_program_env_end2end_assoc_entry_boundary_sound :
  forall env env' f,
...
Theorem check_program_env_end2end_assoc_entry_boundary_sound :
  forall env env' f,
