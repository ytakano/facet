...
- Rocq has env-aware associated compatibility helpers and checked wrapper
  ...
  facts, exact-body route scoped-package wrappers, seen/callee-seen bridge facts, direct-callee component/summary facts,
  and alpha direct-callee facts, plus the summary call-package store-safe
