...
- Done prep: add direct-call runtime wrapper for store-safe narrow callee summaries.
...
- Done prep: add bounded singleton resolved-root chain helper and facts.
- Next: prove resolver transport before wiring indirect borrow/deref cleanup.
