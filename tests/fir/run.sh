...
run_case tests/valid/function/local_let_rec_direct_call.facet "fn __facet_local_rec_0_id_local#0 (x#2: unrestricted isize) -> unrestricted isize"
run_case tests/valid/function/local_let_rec_direct_call.facet "call %t0#0 as unrestricted isize = __facet_local_rec_0_id_local#0 (41 as unrestricted isize)"
run_case tests/valid/function/local_let_rec_capture_direct_call.facet "fn __facet_local_rec_0_f#0 (y#0: unrestricted isize, x#2: unrestricted isize) -> unrestricted isize"
run_case tests/valid/function/local_let_rec_capture_direct_call.facet "call %t0#0 as unrestricted isize = closure __facet_local_rec_0_f#0[y#2 as unrestricted isize] as unrestricted closure(unrestricted isize) -> unrestricted isize (0 as unrestricted isize)"
run_drop_case tests/fir/auto_drop_affine_scalar.facet "x#1 as affine isize"
run_drop_case tests/fir/auto_drop_affine_enum.facet "t#1 as affine Token"
run_drop_case tests/fir/auto_drop_affine_enum_payload.facet "s#1 as affine Slot"
...
run_drop_case tests/fir/auto_drop_enum_partial_match.facet "x#1 as affine isize"
run_drop_absent tests/fir/auto_drop_enum_partial_match.facet "m#1 as affine Maybe"
...
run_case tests/fir/assign_affine_enum_drop_old.facet "replace %t0#0 as affine Slot = s#1 as affine Slot"
run_drop_case tests/fir/assign_affine_enum_drop_old.facet "%t0#0 as affine Slot"
...
run_case tests/fir/assign_mut_ref_affine_enum.facet "replace %t1#0 as affine Slot = *r#1 as affine Slot"
run_drop_case tests/fir/assign_mut_ref_affine_enum.facet "%t1#0 as affine Slot"
