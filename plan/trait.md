...
- Proof infrastructure for direct-call receivers is concentrated around the
  ...
  body-summary sidecar-to-Prop bridge plus conditional and unconditional
  boolean wrappers,
...
- Diagnostic endpoints remain available for the extracted no-receiver body-summary
  ...
  body-summary sidecar now has a Prop bridge plus conditional and unconditional
  boolean wrappers for the active mixed route's component summary provider
  premise,
...
- The remaining activation gap is proof-side. The canonical public runtime
  ...
  can now supply the same provider premise for proofs through conditional and
  unconditional boolean wrappers, but it is not a checker authority.
...
1. Finish direct-call receiver activation.
   ...
   - Use the extracted body-summary sidecar bridge and boolean wrappers to
     factor the remaining summary-provider obligation, then derive that
     obligation from public prefix-route premises or prove an equivalent
...
- The active mixed endpoint has routed lemmas for the known summary,
  ...
  bridge plus boolean wrappers, public Prop-provider wrapper, core mixed no-receiver summary-provider
