...
Proof.
  intros env env' Hprog.
  unfold infer_program_env_end2end_assoc_direct_receiver_absent_mixed
    in Hprog.
  destruct (infer_program_env_end2end_assoc env)
    as [env_checked | err] eqn:Hbase; try discriminate.
  destruct (check_env_end2end_direct_receiver_absent_mixed_ready
    env_checked); try discriminate.
  injection Hprog as <-.
  reflexivity.
Qed.

Lemma infer_program_env_end2end_assoc_direct_receiver_mixed_of_absent_mixed :
  forall env env',
    infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
      infer_ok env' ->
...
Proof.
  ...
  destruct (infer_program_env_end2end_assoc env)
    as [env_checked | err] eqn:Hbase; try discriminate.
  destruct (check_env_end2end_direct_receiver_absent_mixed_ready
    env_checked) eqn:Habsent_ready; try discriminate.
  rewrite
    (check_env_end2end_direct_receiver_mixed_ready_of_absent_mixed_ready
      env_checked Habsent_ready).
  exact Hprog.
Qed.

Theorem infer_program_env_end2end_assoc_direct_receiver_absent_mixed_sound :
  forall env env' f,
    infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
      infer_ok env' ->
    In f (env_fns env') ->
...
Proof.
  intros env env' f Hprog Hin.
  eapply infer_program_env_end2end_assoc_sound; eauto.
  eapply infer_program_env_end2end_assoc_direct_receiver_absent_mixed_base.
  exact Hprog.
Qed.

Lemma check_program_env_end2end_assoc_direct_receiver_absent_mixed_infer_ok :
  forall env,
    check_program_env_end2end_assoc_direct_receiver_absent_mixed env = true ->
    exists env',
      infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
        infer_ok env'.
Proof.
  intros env Hcheck.
  unfold check_program_env_end2end_assoc_direct_receiver_absent_mixed
    in Hcheck.
  destruct (infer_program_env_end2end_assoc_direct_receiver_absent_mixed env)
    as [env' | err] eqn:Hprog; try discriminate.
  exists env'. reflexivity.
Qed.

Theorem check_program_env_end2end_assoc_direct_receiver_absent_mixed_sound :
  forall env env' f,
    check_program_env_end2end_assoc_direct_receiver_absent_mixed env = true ->
    infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
      infer_ok env' ->
...
Proof.
  intros env env' f _ Hprog Hin.
  eapply infer_program_env_end2end_assoc_direct_receiver_absent_mixed_sound;
    eauto.
Qed.

Theorem check_program_env_end2end_assoc_direct_receiver_absent_mixed_sound_exists :
  forall env,
    check_program_env_end2end_assoc_direct_receiver_absent_mixed env = true ->
    exists env',
      infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
...
Proof.
  intros env Hcheck.
  destruct
    (check_program_env_end2end_assoc_direct_receiver_absent_mixed_infer_ok
       env Hcheck) as [env' Hprog].
  exists env'. split; [exact Hprog |].
  intros f Hin.
  eapply infer_program_env_end2end_assoc_direct_receiver_absent_mixed_sound;
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_exact_body_call_route_package_and_component_body_summary_provider_store_static :
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_exact_body_call_route_package_and_component_check_store_static :
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Lemma infer_program_env_end2end_assoc_direct_receiver_absent_mixed_ready_cases :
  forall env env',
    infer_program_env_end2end_assoc_direct_receiver_absent_mixed env =
      infer_ok env' ->
    (check_env_root_shadow_direct_receiver_method_present env' = false /\
...
Proof.
  ...
  destruct (infer_program_env_end2end_assoc env)
    as [env_checked | err] eqn:Hbase; try discriminate.
  destruct (check_env_end2end_direct_receiver_absent_mixed_ready env_checked)
    eqn:Hmixed_ready; try discriminate.
  injection Hprog as <-.
  eapply check_env_end2end_direct_receiver_absent_mixed_ready_cases.
  exact Hmixed_ready.
Qed.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_case_split_exact_body_call_route_package_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
...
Proof.
  ...
  eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_case_split_exact_body_call_route_package.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_prefix.
  - exact Hprefix_ready.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_uncaptured_local_bounds_route_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_uncaptured_local_bounds_route_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_uncaptured_exact_body_route_package_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_uncaptured_exact_body_route_package_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_static_uncaptured_exact_body_route_package_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_uncaptured_exact_body_route_package_callbacks.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_non_captured_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_non_captured_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_non_captured_component_provider_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_non_captured_component_provider_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_static_non_captured_component_provider_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_non_captured_component_provider_callbacks.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_exact_non_captured_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_exact_non_captured_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_static_exact_non_captured_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_exact_non_captured_callbacks.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_static_exact_local_bounds_provider_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_exact_local_bounds_provider_callbacks.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_assoc_base_non_captured_provider_callbacks_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_assoc_base_non_captured_provider_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_static_assoc_base_non_captured_provider_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_static_assoc_base_non_captured_provider_callbacks.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready env env' f s s' v
    Hprog Hsummary_when_no_receiver Hinitial Hin Hstore Heval.
  eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_public_callbacks_and_branch_component_body_summary_evidence.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  - exact Hroots_ready.
...
Theorem infer_program_env_end2end_assoc_direct_receiver_absent_mixed_big_step_safe_checked_initial_ready :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  ...
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  forall env env' f s s' v,
    infer_program_env_end2end_assoc_direct_receiver_absent_mixed
      env = infer_ok env' ->
    check_initial_root_runtime_ready f s = true ->
    In f (env_fns env') ->
    initial_store_for_fn env' f s ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    ...
    Hprog Hinitial Hin Hstore Heval.
  pose proof
    (infer_program_env_end2end_assoc_direct_receiver_mixed_of_absent_mixed
      env env' Hprog) as Hmixed.
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_absent_mixed_ready_cases
      env env' Hprog) as [[_Hno_receiver Habsent] | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_public_callbacks_and_branch_absent_captured_summary.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_ready.
    + exact Hroots_ready.
    ...
    + exact Hparam_ready.
    + exact Hmixed.
    + intros _Hno_receiver_branch. exact Habsent.
    + exact Hinitial.
    + exact Hin.
    + exact Hstore.
    + exact Heval.
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_store_safe_evidence_at_callbacks.
    + exact Hsynthetic_route.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_shadow_summary_at_all_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready env env' f s s' v
    Hprog Hsummary_at_all_when_no_receiver Hinitial Hin Hstore Heval.
  ...
  - intros Hno_receiver.
    ...
    + exact Hroot_names.
    + exact Hroot_keys.
    + exact (Hsummary_at_all_when_no_receiver Hno_receiver).
  - exact Hinitial.
  - exact Hin.
  - exact Hstore.
  - exact Heval.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_evidence_at_all_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_ready Hroots_ready
    Hroot_names Hroot_keys Hframe_ready Hparam_ready env env' f s s' v
    Hprog Hevidence_at_all_when_no_receiver Hinitial Hin Hstore Heval.
  eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_store_safe_evidence_at_callbacks.
  - exact Hsynthetic_route.
  - exact Hscope_synthetic.
  - exact Htyping_ready.
  ...
  - exact Hprog.
  - intros Hno_receiver.
    eapply eval_preserves_typing_roots_store_safe_synthetic_direct_call_ready_summary_at_prefix_call_statement_evidence_at_of_prefix_statement_and_evidence_at_all.
    + exact Hsynthetic_route.
    + exact (Hevidence_at_all_when_no_receiver Hno_receiver).
  - exact Hinitial.
  - exact Hin.
  - exact Hstore.
  - exact Heval.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_exact_body_call_route_package_summary_evidence_at_callbacks :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_package_and_component_body_summary_evidence :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_package_and_component_check :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_routes_and_component_check :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
  ...
  forall env env' f s s' v,
    ...
    value_has_type env' s' v (fn_ret f).
Proof.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_summary_call_routes_and_component_check.
Qed.

Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_package_and_component_body_store_safe_summary_evidence :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_routes_and_component_body_store_safe_summary_evidence :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
  ...
  forall env env' f s s' v,
    ...
    value_has_type env' s' v (fn_ret f).
Proof.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_summary_call_routes_and_component_body_store_safe_summary_evidence.
Qed.

Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_summary_call_routes_and_component_body_summary_evidence :
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_frame_scope_roots_ready_mutual_statement ->
  eval_preserves_param_scope_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
  ...
  forall env env' f s s' v,
    ...
    value_has_type env' s' v (fn_ret f).
Proof.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_summary_call_routes_and_component_body_summary_evidence.
Qed.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_exact_body_call_synthetic_evidence_at_route_and_component_body_closure_check :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
    ...
    (check_env_root_shadow_direct_receiver_method_present env' = false ->
      forall env0 fname fdef fcall used used' fname_body args_body
        ...
        direct_call_target_expr (fn_body fcall) =
          Some (fname_body, args_body, synthetic_body) ->
        fn_root_shadow_synthetic_direct_call_ready_summary_evidence_at
          (global_env_with_local_bounds env0 (fn_bounds fcall)) fname_body) ->
    (check_env_root_shadow_direct_receiver_method_present env' = false ->
      forall env0 fname fdef fcall used used' fname_body args_body,
        In fdef (env_fns env0) ->
        fn_name fdef = fname ->
        ...
        direct_call_target_expr (fn_body fcall) =
          Some (fname_body, args_body, fn_body fcall)) ->
    (check_env_root_shadow_direct_receiver_method_present env' = false ->
      component_body_no_capture_direct_call_component_closure_check_provider
        env') ->
    check_initial_root_runtime_ready f s = true ->
    In f (env_fns env') ->
    initial_store_for_fn env' f s ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_prefix Hprefix_ready
    Htyping_ready Hroots_ready Hroot_names Hroot_keys Hframe_ready
    Hparam_ready env env' f s s' v Hprog Hsummary_route_when_no_receiver
    Hsummary_body_when_no_receiver Hexact_body_when_no_receiver
    Hclosure_when_no_receiver Hinitial Hin Hstore Heval.
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_synthetic_evidence_at_route_and_component_body_closure_check.
    + exact (Hsummary_route_when_no_receiver Hno_receiver).
    + exact Hscope_synthetic.
    + exact Htyping_prefix.
    + exact Hprefix_ready.
    + exact Hroots_ready.
    + exact Hroot_names.
    + exact Hroot_keys.
    + exact (Hsummary_body_when_no_receiver Hno_receiver).
    + exact (Hexact_body_when_no_receiver Hno_receiver).
    + exact Hprog.
    + exact (Hclosure_when_no_receiver Hno_receiver).
    + exact Hinitial.
    + exact Hin.
    + exact Hstore.
    + exact Heval.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_body_summary_provider :
  ...
  forall env env' f s s' v,
    ...
    value_has_type env' s' v (fn_ret f).
Proof.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_exact_body_call_route_package_and_component_body_summary_provider.
Qed.

Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_body_summary_provider_store_static :
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_body_summary_provider.
    + exact Htyping_prefix.
    + exact Hprefix_ready.
    + exact Hroots_ready.
    + exact Hroot_names.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_check_prefix :
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_check :
  ...
  forall env env' f s s' v,
    ...
    value_has_type env' s' v (fn_ret f).
Proof.
  eapply infer_program_env_end2end_assoc_direct_receiver_mixed_big_step_safe_checked_initial_ready_with_exact_body_call_route_package_and_component_check.
Qed.

Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_check_store_static :
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
  eval_preserves_roots_ready_mutual_statement ->
  eval_preserves_root_names_ready_mutual_statement ->
...
Proof.
  ...
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_package_and_component_check.
    + exact Htyping_prefix.
    + exact Hprefix_ready.
    + exact Hroots_ready.
    + exact Hroot_names.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_call_statement_routes_and_component_check_provider :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_call_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_call_statement ->
  forall env env_out f s s_out v,
    infer_program_env_end2end_assoc_direct_receiver_mixed env =
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_call_statement_routes_and_component_check :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_call_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_call_statement ->
  forall env env_out f s s_out v,
    infer_program_env_end2end_assoc_direct_receiver_mixed env =
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_local_bounds_package_and_component_check_store_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_local_bounds_package_and_component_check_static :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_exact_body_call_route_local_bounds_package_and_component_check :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
...
Proof.
  intros Hsynthetic_route Hscope_synthetic Htyping_prefix Hprefix_ready
    ...
    Hcomponent_package_when_no_receiver Hcomponent_check_when_no_receiver
    Hinitial Hin Hstore Heval.
  destruct
    (infer_program_env_end2end_assoc_direct_receiver_mixed_ready_cases
      env env' Hprog) as [Hno_receiver | Hdirect_ready].
  - eapply infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_exact_body_call_route_local_bounds_package_and_component_check_static.
    + exact Hsynthetic_route.
    + exact Hscope_synthetic.
    + exact Htyping_prefix.
    + exact Hprefix_ready.
    ...
    + exact (Hexact_body_when_no_receiver Hno_receiver).
    + exact Hprog.
    + exact (Hcomponent_package_when_no_receiver Hno_receiver).
    + exact (Hcomponent_check_when_no_receiver Hno_receiver).
    + exact Hinitial.
    + exact Hin.
    + exact Hstore.
...
Theorem infer_program_env_end2end_big_step_safe_checked_initial_ready_with_mixed_branch_exact_body_call_route_scoped_package_and_component_check :
  eval_preserves_typing_roots_synthetic_direct_call_ready_prefix_statement ->
  eval_preserves_frame_param_scope_synthetic_direct_call_ready_statement ->
  eval_preserves_typing_ready_prefix_mutual_statement ->
  eval_preserves_typing_roots_ready_prefix_mutual_statement ->
