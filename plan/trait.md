...
- Proof infrastructure for direct-call receivers includes active-mixed branch
  ...
  provider, store-safe summary-evidence, component-check, and component-body
  store-safe summary bridges through active mixed public routes, public-form
...
- The remaining activation gap is proof-side: the strict public subset now
  ...
  store-safe summary-evidence, component-check, and component-body store-safe
  summary branches through active mixed; the canonical
...
- The active mixed endpoint now has strict-to-active checker agreement,
  ...
  component-check routes, and component-body store-safe summary routes,
