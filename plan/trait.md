...
- Helper-level associated compatibility soundness is available for
  ...
  ctx and runtime-side sctx views, including returned root-set naming; store
  typed and prefix-store-typed roots-ready bridges can consume env and root-set
  lists from the sctx view directly. Assoc root value and argument typing bridge
  to the same roots-ready invariants. Ordinary
