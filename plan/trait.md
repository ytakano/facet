...
- Ready-body fallback proof infrastructure now supplies local-bounds providers,
  explicit ordinary/synthetic-to-ready evidence adapters, a named summary-family
  route bridge, route-package/reachability helpers, exact-target adapters,
  pointwise callee evidence, callback-at/local-bounds callback bridges,
  ready-body-to-synthetic component callback providers, and checker-to-callback-at
  provider bridges. This gives synthetic-or-ordinary callee evidence plus
  store-safe target arguments for alpha-renamed direct targets.
...
- The active mixed endpoint has the needed direct-ready branch, assoc-base
  ...
  bridges up through named evidence, summary-family, and callback-at providers.
  It still lacks the lower preservation theorem route that lets the mixed
  no-receiver proof consume ready-body synthetic-or-ordinary evidence instead of
